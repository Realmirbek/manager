...
urlpatterns = [
    ...
    # Новый маршрут для просмотра списка менторов
    path('mentors/', mentor_list, name='mentor_list'),

    # Новый маршрут для редактирования ментора
    path('edit_mentor/<int:mentor_id>/', edit_mentor, name='edit_mentor'),

    # Новый маршрут для удаления пользователя (стажера или ментора) навсегда
